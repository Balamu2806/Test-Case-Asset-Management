...
int updateReservedStock = GlobalVariable.Reserved_Stock + Req_Qty


GlobalVariable.Ref_No = CustomKeywords.'myPack.Convert.toString'(updateReservedStock, 3)
...
GlobalVariable.Ref_No = CustomKeywords.'myPack.Convert.toString'(GlobalVariable.Unrestricted_Stock, 3)
