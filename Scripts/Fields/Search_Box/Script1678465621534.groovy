...
WebUI.setText(findTestObject('Page_PM360/Search_Box_Input'), GlobalVariable.OrderID)
...
WebUI.click(findTestObject('Page_PM360/Order_ID', [('OrderID') : GlobalVariable.OrderID]))
